...
public class AudioConfigEditor : Editor
{
    ...
    public static void Absorb()
    {
        ...
        DirectoryInfo dir = new DirectoryInfo(Application.dataPath + "/Extension/Audio/Music");
        string[] subdirectory = Directory.GetDirectories(Application.dataPath + "/Extension/Audio/Music");
        subdirectory.Append(Application.dataPath + "/Extension/Audio/Music");
